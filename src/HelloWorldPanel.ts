...
import { getUri } from "./webview/util";
...
export class HelloWorldPanel {
    ...
    webview.onDidReceiveMessage(async (data: any) => {
      switch (data.type) {
        case "onInfo": {
          ...
          vscode.window.showInformationMessage(data.valuie);
          break;
        }
        case "onError": {
          if (!data.value) {
  ...
  private _getHtmlForWebview(webview: vscode.Webview) {
    ...
    const tkUri = getUri(webview, this._extensionUri, [
      "node_modules",
      "@vscode",
      "webview-ui-toolkit",
      "dist",
    ...
    // // Use a nonce o only allow specific scripts to be run
  ...
  // 		<html lang="en">
  // 		<head>
  //               <link rel="${stylesResetUri}" rel="stylesheet" />
  //               <link rel="${stylesMainUri}" rel="stylesheet" />
  // 			<meta charset="UTF-8">
  // 			<!--
  ...
  //               <input />
  //               <p> test </p>
  //               <p id="text"> Are my changes registering </p>
